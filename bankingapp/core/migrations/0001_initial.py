    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('BANKER', 'Banker'), ('CLIENT', 'Client')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='debit_card', to='core.bankaccount')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
